					...
					<div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
						<form action="login.php" method="POST">
							<div class="login-form">
								...
								<p><span class="font-weight-bold">Bạn đã có tài khoản của SWA? đăng nhập ngay!</span></p>
								<div class="row">
									<div class="col-md-12 col-12 mb--15">
										<label for="email">Nhập tên đăng nhập ở đây</label>
										<input class="mb-0 form-control" type="text" name="tendn" placeholder="Vui lòng nhập tài khoản">
