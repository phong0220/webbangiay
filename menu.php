                        ...
                        <div class="col-lg-2" >
                            <div class="header-phone ">
                                ...
                                <div class="text">
                                    ...
                                    <p class="font-weight-bold number">0857368167</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8" >
                        ...
                        <div class="col-lg-5">
                            <div class="header-search-block">
								<form action="search.php" method="GET">
             					<input type="text" name="search" placeholder="Nhập vào từ khóa sản phẩm bạn muốn mua :3">
                ...
                <div class="off-canvas-inner">
                    ...
                    <div class="mobile-navigation">
                        ...
                        <div class="off-canvas-bottom">
                            ...
                            <a href="#" class="sin-contact"><i class="fas fa-mobile-alt"></i>0857368167</a>
